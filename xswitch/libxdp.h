...
/* NOTE: Adapted from <linux/if_link.h> copying them here instead because when compiling
 * with OpenVSwitch results in redefinition of struct nla_bitfield32 also defined in OVS
