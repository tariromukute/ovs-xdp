					...
					struct xdp_key_ethernet **key_eth)
{
	...
	bpf_printk("parse_xdp_key_ethhdr: %llx\n", ether_addr_to_u64(eth.eth_dst));
					  ...
					  struct xdp_key_icmpv6 **key_icmpv6)
{
	...
	bpf_printk("-- parse_xdp_key_icmp6hdr type: %u type2: %u code: %u\n", icmp6h->icmp6_type, icmpv6.icmpv6_type, icmp6h->icmp6_code);
	*key_icmpv6 = &icmpv6;
